...
export default function Interests() {
  return (
    <div className="mx-auto grid grid-cols-1 items-center gap-4 px-4 py-4 lg:grid-cols-2 bg-gray-900/90 rounded-2xl">
      <div className="h-full bg-gray-600/50 rounded-xl p-4">
